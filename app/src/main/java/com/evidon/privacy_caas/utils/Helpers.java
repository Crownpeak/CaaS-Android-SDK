...
public class Helpers {
    ...
    public static void showPrivacy (AppCompatActivity activity) {
        FragmentManager fm = activity.getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        Fragment prev = fm.findFragmentByTag("dialog_about");
        if (prev != null) {
        ...
        new PrivacyDialog().show(ft, "dialog_about");
    }
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        String urlgooglelus = "https://www.evidon.com";
        String urlcommunity = "https://www.evidon.com";
        String urltwitter = "https://www.evidon.com";
        String urlgithub = "https://github.com/crownpeak";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            try {
                ...
                appversion.setText("Privacy_CaaS");
    ...
    public static class PrivacyDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            LayoutInflater layoutInflater = (LayoutInflater) getActivity().getSystemService(
                    Context.LAYOUT_INFLATER_SERVICE);
            LinearLayout aboutBodyView = (LinearLayout) layoutInflater.inflate(R.layout.layout_privacy_dialog, null);
